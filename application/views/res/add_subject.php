                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                ...
                                                <?php echo form_open_multipart('subject/create');?> 
                                                    <form  method="post" action="<?php echo base_url(),"index.php/subject/create"?>" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="name" type="text" class="form-control" placeholder="Subject Name"  value="<?php echo set_value("name")?>">
                                                                    <?php echo form_error("name")?>
                                                                </div>
                                                               
                                                                <div class="form-group">
                                                                <label name="class"><?php echo $this->lang->line('class')?></label>
                                                                ...
                                                                <div class="form-group">
                                                                <label name="choose teacher"><?php echo $this->lang->line('choose teacher')?></label>
...
<?php endif;?>
                                                                ...
                                                                <div class="form-group">
                                                                <a hreh ="<?php echo base_url(),'index.php/subject/create';?>" ><button type="submit" value="add"  name="add"><?php echo $this->lang->line('add')?></button>  </a>
                                                                </div>
