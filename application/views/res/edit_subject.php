                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-payment-inner-st">
                            <ul id="myTabedu1" class="tab-review-design">
                                <li class="active"><a href="#description">Update Teacher</a></li>
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad">
                                                    <form  method="post" action="<?php echo base_url().'index.php/subject/edit1/';?>" class="dropzone dropzone-custom needsclick add-professors" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="Name" type="text" class="form-control" placeholder="Enter your  name" value="<?= $teacher['name'];?>">
                                                                </div>
...
<?php endforeach;?>
                                                                ...
                                                                <div class="form-group">
                                                                <a hreh ="<?php echo base_url(),'index.php/subject/create';?>" ><button type="submit" value="add" >update</button>  </a>
                                                                </div>
