                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            ...
                            <div class="add-product">
                                <a href="<?=base_url();?>index.php/subject/add_subject" name="add subject"><?php echo $this->lang->line('add subject');?></a>
                            </div>
                            <div class="asset-inner">
                                <table>
                                    <tr>
                                        <th><?php echo $this->lang->line('s_id');?></th>
                                    ...
                                    <tr>
                                      ...
                                      <td> <?= $row->grade ?></td>
                                      <td> <?= $row->t_id ?></td>
                                      <td> <a href="<?php echo base_url().'index.php/subject/edit/'.$row->t_id;?>" > <button data-toggle="tooltip" title="edit" class="">Edit<i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></td>

                                      <td> <a href="<?php echo base_url().'index.php/subject/delete/'.$row->s_id;?>" > <button data-toggle="tooltip" title="delete" class="">delete<i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></td>
                                      </tr> 
                                    <?php //if($row->grade > $last_g):?>
