                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <form role="search" class="sr-input-func" action="<?=base_url();?>index.php/home/search" method="post">
                                                <input type="text" placeholder="Search..." class="search-int form-control" name="name">
                                                <a href="<?=base_url();?>index.php/home/search_teacher"><i class="fa fa-search"></i></a>
                                            </form>
                                        </div>
                                    </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="product-status-wrap">
                            <h4 name="all teacher">Teachers List</h4>
                            <div class="add-product">
                                <a href="<?=base_url();?>index.php/home/insert_teacher"  name="add teacher"><?php echo $this->lang->line('add teacher');?></a>
                            </div>
                            <div class="asset-inner">
                                <table>
                                    <tr>
                                        ...
                                        <th><?php echo $this->lang->line('name_t');?></th>
                                        <th><?php echo $this->lang->line('father_name');?></th>
                                        <th><?php echo $this->lang->line('phone');?></th>
                                        <th><?php echo $this->lang->line('Jop_date');?></th>
                                        <th><?php echo $this->lang->line('Salary');?></th>
                                        <th><?php echo $this->lang->line('Birthday');?></th>
                                        <th><?php echo $this->lang->line('Current Jop Location');?></th>
                                        <th><?php echo $this->lang->line('Previous Jop Location');?></th>
                                    ...
                                    <tr>
                                    <td> <?= $row->t_id ?></td>
                                      <td> <img src="<?=base_url()?>assets/upload/<?=$row->image ?>"/></td>
                                      <td> <?= $row->name ?></td>
                                      ...
                                      <td> <?= $row->salary ?></td>
                                      <td> <?= $row->birthday ?></td>
                                      <td> <?= $row->pervious_jop_location ?></td>
                                      <td> <?= $row->current_jop_location ?></td>
                                      <td>
                                           
                                       <a href="<?php echo base_url().'index.php/home/edit/'.$row->t_id;?>" ><button data-toggle="tooltip" title="Edit" class="pd-setting-ed" name="edit">Edit<i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a>
                                      </td> 
                                      <td> <a href="<?php echo base_url().'index.php/home/delete/'.$row->t_id;?>" > <button data-toggle="tooltip" title="delete" class="" name="delete">delete<i class="fa fa-pencil-square-o" aria-hidden="true"></i></button></a></td>
